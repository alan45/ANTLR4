...
public interface SkinnyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SkinnyParser#assignment}.
	 * @param ctx the parse tree
	 */
	void enterAssignment(SkinnyParser.AssignmentContext ctx);
	/**
	 * Exit a parse tree produced by {@link SkinnyParser#assignment}.
	 * @param ctx the parse tree
	 */
	void exitAssignment(SkinnyParser.AssignmentContext ctx);
	/**
